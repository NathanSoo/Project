...
Patterns:
	.db 0b11111111, 0b01111111, 0b00111111, 0b00011111  ; Pattern 0-3
    .db 0b00001111, 0b00000111, 0b00000011, 0b00000001  ; Pattern 4-7
    .db 0b00000000, 0b00000000                          ; Pattern 8-9
